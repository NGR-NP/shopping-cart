...
const CartBadge = () => {
    ...
    return (
        <div className="flex relative items-center md:order-2 max-md:ml-auto ">
            <button type="button" onClick={() => navigate("/cart")} className="flex mr-3 text-sm bg-gray-800 p-2 rounded-full max-md:mr-6  focus:outline-none focus:ring-2  text-gray-400 hover:bg-gray-700 focus:ring-gray-600" id="user-menu-button">
